...
<!DOCTYPE html>
    ...
    <head>
        ...
        <sql:query dataSource="${myDatasource}" var="data">
            select * from hotel where flag=? and location=?
            <sql:param>A</sql:param><sql:param>${details.location}</sql:param>
        </sql:query>
                ...
                <c:forEach items="${data.rows}" var="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <p>
                            ...
                            <a href="checkboxcontroller?id=${row.id}" class="btn btn-primary">Book</a>
                        </p>
                    </div>
                </c:forEach>    
            </div>
